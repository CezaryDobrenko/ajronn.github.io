...
class Swimlane extends React.Component{
    ...
    render(){
       ...
       return (
           <div>
            <Collapsible trigger={<div><input style={{width: "150px", height: "20px"}}type="text" defaultValue={this.props.element.title}></input><button onClick={() => this.props.removeSwimlane(this.props.element)}>Remove swimlane</button><button onClick={() => this.addColumn(this.props.element)}>Add column</button></div>}>
