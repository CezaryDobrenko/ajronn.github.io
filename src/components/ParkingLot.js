...
const ParkingLot = (props) =>{
    ...
    const ournotes = props.notes.map((e,index) => {
        return(
            <Note removeTask={props.removeTask} addTask={props.addTask} changeTaskStatus={props.changeTaskStatus} changeNoteStatus={props.changeNoteStatus} checkUserLimit={props.checkUserLimit}
